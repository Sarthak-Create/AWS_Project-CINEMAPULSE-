...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'cinemapulse_dev_key')


app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 'kingsarthakrana@gmail.com'
app.config['MAIL_PASSWORD'] = 'afrrpgltuvlnguau'  
app.config['MAIL_DEFAULT_SENDER'] = 'kingsarthakrana@gmail.com'
...
def submit_feedback():
    ...
    user_display_name = f"User_{random.randint(100,999)}"
